...
module Visor
  module API
    ...
    #
    # The API is multi-format, most properly it supports response encoding in JSON and XML formats.
    ...
    # If no Accept header is provided, API will encode and render it as JSON by default.
    #
    ...
    class Server < Goliath::API
      ...
      #
      # Get image data and detailed metadata for the given id, see {Visor::API::GetImage}.
      #
      ...
      #
      # Put image metadata and/or data for the image with the given id, see {Visor::API::PutImage}.
      #
      # The image metadata should be encoded as HTTP headers and passed with the request, as the following example:
      #
