...
describe Visor::API::Store::HTTP do

  let(:klass) { Visor::API::Store::HTTP }
  ...
  before(:all) do
    @valid_http = Visor::API::Store::HTTP.new(http_uri)
    @invalid_http = Visor::API::Store::HTTP.new('http://a1g2.fake.com/')
  end

  describe "#initialize" do
    it "should initialize http store class" do
      @valid_http.should be_a Visor::API::Store::HTTP
    end
  end
