...
describe Visor::API::Meta do

  let(:meta) { Visor::API::Meta.new }
  ...
  describe "#initialize" do
    it "should create a new meta api object with default parameters" do
      meta.host.should == Visor::API::Meta::DEFAULT_HOST
      meta.port.should == Visor::API::Meta::DEFAULT_PORT
    end

    it "should create a new meta api object with custom parameters" do
      custom = Visor::API::Meta.new(host: '0.0.0.0', port: 1111)
