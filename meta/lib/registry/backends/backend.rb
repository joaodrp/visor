  ...
  module Backends
    class Backend
      ...
      def validate_data_put(meta)
        ...
        meta.assert_valid_values(:architecture, ARCHITECTURE)
        meta.assert_valid_values(:access, ACCESS)
        meta.assert_valid_values(:format, FORMAT)
        meta.assert_valid_values(:type, TYPE)
        meta.assert_valid_values(:store, STORE)
